...
//! authors : Lucas Sanders, Tim Wood, Iskren Chernev, Moment.js contributors
//! license : MIT
//! whoopinc.github.io/frozen-moment
...
(function (undefined) {
    ...
    ************************************/
    ...
    function FrozenDuration(duration) {
        ...
        this._locale = frozenMoment.localeData();
    ...
    ************************************/
    ...
    function makeList(field) {
        ...
        frozenMoment[field] = function (format, index) {
            var i, getter,
                method = frozenMoment.fn._locale[field],
                results = [];
            ...
            getter = function (i) {
                ...
                return method.call(frozenMoment.fn._locale, m, format || '');
            };
    ...
    function weeksInYear(year, dow, doy) {
        return weekOfYear(frozenMoment([year, 11, 31 + dow - doy]), dow, doy).week;
    }
    ...
    function makeAsBuilder(input, model) {
        ...
        if (model._isUTC) {
            ...
            return momentBuilder(input).local();
        }
    }
    ...
    ************************************/
    ...
    function addTimeToArrayFromToken(token, input, config) {
        ...
        // YEAR
        case 'YY' :
            datePartArray[YEAR] = frozenMoment.parseTwoDigitYear(input);
            break;
        case 'YYYY' :
        case 'YYYYY' :
        case 'YYYYYY' :
        ...
        case 'GG':
            config._w = config._w || {};
            config._w[token] = frozenMoment.parseTwoDigitYear(input);
        }
    }
    ...
    function dayOfYearFromWeekInfo(config) {
        ...
        if (w.GG != null || w.W != null || w.E != null) {
            ...
            weekYear = dfl(w.gg, config._a[YEAR], weekOfYear(frozenMoment(), dow, doy).year);
            week = dfl(w.w, 1);
    ...
    function makeDateFromStringAndFormat(config) {
        if (config._f === frozenMoment.ISO_8601) {
            parseISO(config);
            return;
        }
    ...
    function makeDateFromString(config) {
        ...
        if (config._isValid === false) {
            ...
            frozenMoment.createFromInputFallback(config);
        }
    }
    ...
    ************************************/
    ...
    // helper function for frozenMoment.fn.from, frozenMoment.fn.fromNow, and frozenMoment.duration.fn.humanize
    ...
    ************************************/
    ...
    function makeMoment(config) {
        ...
        return new FrozenMoment(config);
    }
    ...
    function pickBy(fn, frozenMoments) {
        ...
        if (frozenMoments.length === 1 && isArray(frozenMoments[0])) {
            frozenMoments = frozenMoments[0];
        }
        if (!frozenMoments.length) {
            return frozenMoment();
        }
        res = frozenMoments[0];
        for (i = 1; i < frozenMoments.length; ++i) {
            if (frozenMoments[i][fn](res)) {
                res = frozenMoments[i];
            }
        }
        return res;
    ...
    frozenMoment.min = function () {
        var args = [].slice.call(arguments, 0);

        return pickBy('isBefore', args);
    };

    frozenMoment.max = function () {
        var args = [].slice.call(arguments, 0);
    ...
    frozenMoment.unix = function (input) {
        return frozenMoment(input * 1000);
    };
    ...
    // default format
    frozenMoment.defaultFormat = isoFormat;

    // constant that refers to the ISO standard
    frozenMoment.ISO_8601 = function () {};
    ...
    frozenMoment.normalizeUnits = function (units) {
        return normalizeUnits(units);
    };

    frozenMoment.invalid = function (flags) {
        var m = frozenMoment.utc(NaN);
        if (flags != null) {
            extend(m._pf, flags);
        }
        else {
    ...
    ************************************/
    ...
    extend(momentBuilder.fn = MomentBuilder.prototype, {
        ...
        day : function (input) {
            ...
            input = parseWeekday(input, this.freeze().localeData());
        ...
        weekYear : function (input) {
            var frozen = this.freeze(),
                year = weekOfYear(frozen, frozen.localeData()._week.dow, frozen.localeData()._week.doy).year;
        ...
        week : function (input) {
            var frozen = this.freeze(),
                week = frozen.localeData().week(frozen);
        ...
        weekday : function (input) {
            var frozen = this.freeze(),
                weekday = (frozen.day() + 7 - frozen.localeData()._week.dow) % 7;
    ...
    function rawMonthSetter(mom, value) {
        ...
        if (typeof value === 'string') {
            value = mom.freeze().localeData().monthsParse(value);
    ...
    ************************************/
    ...
    extend(frozenMoment.fn = FrozenMoment.prototype, {
        ...
        toString : function () {
            return this.thaw().locale('en').freeze().format('ddd MMM DD YYYY HH:mm:ss [GMT]ZZ');
        },
        ...
        isDSTShifted : function () {
            if (this._a) {
                return this.isValid() && compareArrays(this._a, (this._isUTC ? frozenMoment.utc(this._a) : frozenMoment(this._a)).toArray()) > 0;
            }
        ...
        from : function (time, withoutSuffix) {
            return frozenMoment.duration.build({to: this, from: time}).locale(this.locale()).freeze().humanize(!withoutSuffix);
        },

        fromNow : function (withoutSuffix) {
            return this.from(frozenMoment(), withoutSuffix);
        },
    ...
    ************************************/
    ...
    frozenMoment.duration.fn.toString = frozenMoment.duration.fn.toISOString;
    ...
    frozenMoment.duration.fn.asMilliseconds = function () {
        return this.as('ms');
    };
    frozenMoment.duration.fn.asSeconds = function () {
        return this.as('s');
    };
    frozenMoment.duration.fn.asMinutes = function () {
        return this.as('m');
    };
    frozenMoment.duration.fn.asHours = function () {
        return this.as('h');
    };
    frozenMoment.duration.fn.asDays = function () {
        return this.as('d');
    };
    frozenMoment.duration.fn.asWeeks = function () {
        return this.as('weeks');
    };
    frozenMoment.duration.fn.asMonths = function () {
        return this.as('M');
    };
    frozenMoment.duration.fn.asYears = function () {
        return this.as('y');
    };
