...
exports.add = {
    ...
    "add short args" : function (test) {
        ...
        b = frozenMoment([2010, 0, 31]).add({M: 1});
        c = frozenMoment([2010, 1, 28]).subtract({M: 1});
        d = frozenMoment([2010, 1, 28]).subtract({Q: 1});
    ...
    "add across DST" : function (test) {
        ...
        var a = frozenMoment(new Date(2011, 2, 12, 5, 0, 0)),
            b = frozenMoment(new Date(2011, 2, 12, 5, 0, 0)),
            c = frozenMoment(new Date(2011, 2, 12, 5, 0, 0)),
            d = frozenMoment(new Date(2011, 2, 12, 5, 0, 0)),
            e = frozenMoment(new Date(2011, 2, 12, 5, 0, 0));
        a.add(1, 'days');
        b.add(24, 'hours');
        c.add(1, 'months');
        e.add(1, 'quarter');
