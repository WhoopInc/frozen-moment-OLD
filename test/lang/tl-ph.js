...
exports["lang:tl-ph"] = {
    ...
    "from" : function (test) {
        ...
        test.equal(start.from(frozenMoment([2007, 1, 28]).add({s: 44}), true),  "ilang segundo", "44 seconds = a few seconds");
    ...
    "suffix" : function (test) {
        test.equal(frozenMoment(30000).from(0), "sa loob ng ilang segundo", "prefix");
        test.equal(frozenMoment(0).from(30000), "ilang segundo ang nakalipas", "suffix");
        test.done();
    },

    "fromNow" : function (test) {
        test.equal(frozenMoment().add({s: 30}).fromNow(), "sa loob ng ilang segundo", "in a few seconds");
