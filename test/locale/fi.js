...
exports["locale:fi"] = {
    ...
    "format ordinal" : function (test) {
        test.equal(frozenMoment([2011, 0, 1]).format('DDDo'), '1.', '1st');
        test.equal(frozenMoment([2011, 0, 2]).format('DDDo'), '2.', '2nd');
        test.equal(frozenMoment([2011, 0, 3]).format('DDDo'), '3.', '3rd');
        test.equal(frozenMoment([2011, 0, 4]).format('DDDo'), '4.', '4th');
        test.equal(frozenMoment([2011, 0, 5]).format('DDDo'), '5.', '5th');
        test.equal(frozenMoment([2011, 0, 6]).format('DDDo'), '6.', '6th');
        test.equal(frozenMoment([2011, 0, 7]).format('DDDo'), '7.', '7th');
        test.equal(frozenMoment([2011, 0, 8]).format('DDDo'), '8.', '8th');
        test.equal(frozenMoment([2011, 0, 9]).format('DDDo'), '9.', '9th');
        test.equal(frozenMoment([2011, 0, 10]).format('DDDo'), '10.', '10th');

        test.equal(frozenMoment([2011, 0, 11]).format('DDDo'), '11.', '11th');
        test.equal(frozenMoment([2011, 0, 12]).format('DDDo'), '12.', '12th');
        test.equal(frozenMoment([2011, 0, 13]).format('DDDo'), '13.', '13th');
        test.equal(frozenMoment([2011, 0, 14]).format('DDDo'), '14.', '14th');
        test.equal(frozenMoment([2011, 0, 15]).format('DDDo'), '15.', '15th');
        test.equal(frozenMoment([2011, 0, 16]).format('DDDo'), '16.', '16th');
        test.equal(frozenMoment([2011, 0, 17]).format('DDDo'), '17.', '17th');
        test.equal(frozenMoment([2011, 0, 18]).format('DDDo'), '18.', '18th');
        test.equal(frozenMoment([2011, 0, 19]).format('DDDo'), '19.', '19th');
        test.equal(frozenMoment([2011, 0, 20]).format('DDDo'), '20.', '20th');

        test.equal(frozenMoment([2011, 0, 21]).format('DDDo'), '21.', '21st');
        test.equal(frozenMoment([2011, 0, 22]).format('DDDo'), '22.', '22nd');
        test.equal(frozenMoment([2011, 0, 23]).format('DDDo'), '23.', '23rd');
        test.equal(frozenMoment([2011, 0, 24]).format('DDDo'), '24.', '24th');
        test.equal(frozenMoment([2011, 0, 25]).format('DDDo'), '25.', '25th');
        test.equal(frozenMoment([2011, 0, 26]).format('DDDo'), '26.', '26th');
        test.equal(frozenMoment([2011, 0, 27]).format('DDDo'), '27.', '27th');
        test.equal(frozenMoment([2011, 0, 28]).format('DDDo'), '28.', '28th');
        test.equal(frozenMoment([2011, 0, 29]).format('DDDo'), '29.', '29th');
        test.equal(frozenMoment([2011, 0, 30]).format('DDDo'), '30.', '30th');

        test.equal(frozenMoment([2011, 0, 31]).format('DDDo'), '31.', '31st');
        test.done();
    },
    ...
    "from" : function (test) {
        ...
        test.equal(start.from(frozenMoment([2007, 1, 28]).add({s: 44}), true),  "muutama sekunti", "44 seconds = few seconds");
        test.equal(start.from(frozenMoment([2007, 1, 28]).add({s: 45}), true),  "minuutti",      "45 seconds = a minute");
        test.equal(start.from(frozenMoment([2007, 1, 28]).add({s: 89}), true),  "minuutti",      "89 seconds = a minute");
        test.equal(start.from(frozenMoment([2007, 1, 28]).add({s: 90}), true),  "kaksi minuuttia",     "90 seconds = 2 minutes");
        test.equal(start.from(frozenMoment([2007, 1, 28]).add({m: 44}), true),  "44 minuuttia",    "44 minutes = 44 minutes");
        test.equal(start.from(frozenMoment([2007, 1, 28]).add({m: 45}), true),  "tunti",       "45 minutes = an hour");
        test.equal(start.from(frozenMoment([2007, 1, 28]).add({m: 89}), true),  "tunti",       "89 minutes = an hour");
        test.equal(start.from(frozenMoment([2007, 1, 28]).add({m: 90}), true),  "kaksi tuntia",       "90 minutes = 2 hours");
        test.equal(start.from(frozenMoment([2007, 1, 28]).add({h: 5}), true),   "viisi tuntia",       "5 hours = 5 hours");
        test.equal(start.from(frozenMoment([2007, 1, 28]).add({h: 21}), true),  "21 tuntia",      "21 hours = 21 hours");
        test.equal(start.from(frozenMoment([2007, 1, 28]).add({h: 22}), true),  "päivä",         "22 hours = a day");
        test.equal(start.from(frozenMoment([2007, 1, 28]).add({h: 35}), true),  "päivä",         "35 hours = a day");
        test.equal(start.from(frozenMoment([2007, 1, 28]).add({h: 36}), true),  "kaksi päivää",        "36 hours = 2 days");
        test.equal(start.from(frozenMoment([2007, 1, 28]).add({d: 1}), true),   "päivä",         "1 day = a day");
        test.equal(start.from(frozenMoment([2007, 1, 28]).add({d: 5}), true),   "viisi päivää",        "5 days = 5 days");
        test.equal(start.from(frozenMoment([2007, 1, 28]).add({d: 25}), true),  "25 päivää",       "25 days = 25 days");
        test.equal(start.from(frozenMoment([2007, 1, 28]).add({d: 26}), true),  "kuukausi",       "26 days = a month");
        test.equal(start.from(frozenMoment([2007, 1, 28]).add({d: 30}), true),  "kuukausi",       "30 days = a month");
        test.equal(start.from(frozenMoment([2007, 1, 28]).add({d: 43}), true),  "kuukausi",       "43 days = a month");
        test.equal(start.from(frozenMoment([2007, 1, 28]).add({d: 46}), true),  "kaksi kuukautta",      "46 days = 2 months");
        test.equal(start.from(frozenMoment([2007, 1, 28]).add({d: 74}), true),  "kaksi kuukautta",      "75 days = 2 months");
        test.equal(start.from(frozenMoment([2007, 1, 28]).add({d: 76}), true),  "kolme kuukautta",      "76 days = 3 months");
        test.equal(start.from(frozenMoment([2007, 1, 28]).add({M: 1}), true),   "kuukausi",       "1 month = a month");
        test.equal(start.from(frozenMoment([2007, 1, 28]).add({M: 5}), true),   "viisi kuukautta",      "5 months = 5 months");
        test.equal(start.from(frozenMoment([2007, 1, 28]).add({d: 345}), true), "vuosi",        "345 days = a year");
        test.equal(start.from(frozenMoment([2007, 1, 28]).add({d: 548}), true), "kaksi vuotta",       "548 days = 2 years");
        test.equal(start.from(frozenMoment([2007, 1, 28]).add({y: 1}), true),   "vuosi",        "1 year = a year");
        test.equal(start.from(frozenMoment([2007, 1, 28]).add({y: 5}), true),   "viisi vuotta",       "5 years = 5 years");
        test.done();
    },

    "suffix" : function (test) {
        test.equal(frozenMoment(30000).from(0), "muutaman sekunnin päästä",  "prefix");
        test.equal(frozenMoment(0).from(30000), "muutama sekunti sitten", "suffix");
        test.done();
    },

    "now from now" : function (test) {
        test.equal(frozenMoment().fromNow(), "muutama sekunti sitten",  "now from now should display as in the past");
        test.done();
    },

    "fromNow" : function (test) {
        test.equal(frozenMoment().add({s: 30}).fromNow(), "muutaman sekunnin päästä", "in a few seconds");
        test.equal(frozenMoment().add({d: 5}).fromNow(), "viiden päivän päästä", "in 5 days");
        test.done();
    },
    ...
    "calendar day" : function (test) {
        ...
        test.equal(frozenMoment(a).calendar(),                     "tänään klo 02.00",     "today at the same time");
        test.equal(frozenMoment(a).add({m: 25}).calendar(),      "tänään klo 02.25",     "Now plus 25 min");
        test.equal(frozenMoment(a).add({h: 1}).calendar(),       "tänään klo 03.00",     "Now plus 1 hour");
        test.equal(frozenMoment(a).add({d: 1}).calendar(),       "huomenna klo 02.00",  "tomorrow at the same time");
        test.equal(frozenMoment(a).subtract({h: 1}).calendar(),  "tänään klo 01.00",     "Now minus 1 hour");
        test.equal(frozenMoment(a).subtract({d: 1}).calendar(),  "eilen klo 02.00", "yesterday at the same time");
        test.done();
    },
