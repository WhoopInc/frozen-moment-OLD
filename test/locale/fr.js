...
exports['locale:fr'] = {
    ...
    'weeks year starting sunday formatted' : function (test) {
        ...
        test.equal(frozenMoment([2012, 0,  2]).format('w ww wo'), '1 01 1er', 'Jan  2 2012 should be week 1');
        test.equal(frozenMoment([2012, 0,  8]).format('w ww wo'), '1 01 1er', 'Jan  8 2012 should be week 1');
