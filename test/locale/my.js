...
exports['locale:my'] = {
    ...
    'format ordinal': function (test) {
        test.expect(31);
        test.equal(frozenMoment([2011, 0, 1]).format('DDDo'), '၁', '၁');
        test.equal(frozenMoment([2011, 0, 2]).format('DDDo'), '၂', '၂');
        test.equal(frozenMoment([2011, 0, 3]).format('DDDo'), '၃', '၃');
        test.equal(frozenMoment([2011, 0, 4]).format('DDDo'), '၄', '၄');
        test.equal(frozenMoment([2011, 0, 5]).format('DDDo'), '၅', '၅');
        test.equal(frozenMoment([2011, 0, 6]).format('DDDo'), '၆', '၆');
        test.equal(frozenMoment([2011, 0, 7]).format('DDDo'), '၇', '၇');
        test.equal(frozenMoment([2011, 0, 8]).format('DDDo'), '၈', '၈');
        test.equal(frozenMoment([2011, 0, 9]).format('DDDo'), '၉', '၉');
        test.equal(frozenMoment([2011, 0, 10]).format('DDDo'), '၁၀', '၁၀');

        test.equal(frozenMoment([2011, 0, 11]).format('DDDo'), '၁၁', '၁၁');
        test.equal(frozenMoment([2011, 0, 12]).format('DDDo'), '၁၂', '၁၂');
        test.equal(frozenMoment([2011, 0, 13]).format('DDDo'), '၁၃', '၁၃');
        test.equal(frozenMoment([2011, 0, 14]).format('DDDo'), '၁၄', '၁၄');
        test.equal(frozenMoment([2011, 0, 15]).format('DDDo'), '၁၅', '၁၅');
        test.equal(frozenMoment([2011, 0, 16]).format('DDDo'), '၁၆', '၁၆');
        test.equal(frozenMoment([2011, 0, 17]).format('DDDo'), '၁၇', '၁၇');
        test.equal(frozenMoment([2011, 0, 18]).format('DDDo'), '၁၈', '၁၈');
        test.equal(frozenMoment([2011, 0, 19]).format('DDDo'), '၁၉', '၁၉');
        test.equal(frozenMoment([2011, 0, 20]).format('DDDo'), '၂၀', '၂၀');

        test.equal(frozenMoment([2011, 0, 21]).format('DDDo'), '၂၁', '၂၁');
        test.equal(frozenMoment([2011, 0, 22]).format('DDDo'), '၂၂', '၂၂');
        test.equal(frozenMoment([2011, 0, 23]).format('DDDo'), '၂၃', '၂၃');
        test.equal(frozenMoment([2011, 0, 24]).format('DDDo'), '၂၄', '၂၄');
        test.equal(frozenMoment([2011, 0, 25]).format('DDDo'), '၂၅', '၂၅');
        test.equal(frozenMoment([2011, 0, 26]).format('DDDo'), '၂၆', '၂၆');
        test.equal(frozenMoment([2011, 0, 27]).format('DDDo'), '၂၇', '၂၇');
        test.equal(frozenMoment([2011, 0, 28]).format('DDDo'), '၂၈', '၂၈');
        test.equal(frozenMoment([2011, 0, 29]).format('DDDo'), '၂၉', '၂၉');
        test.equal(frozenMoment([2011, 0, 30]).format('DDDo'), '၃၀', '၃၀');

        test.equal(frozenMoment([2011, 0, 31]).format('DDDo'), '၃၁', '၃၁');
        test.done();
    },
    ...
    'from': function (test) {
        ...
        test.equal(start.from(frozenMoment([2007, 1, 28]).add({
            s: 44
    ...
    'suffix': function (test) {
        test.expect(2);
        test.equal(frozenMoment(30000).from(0), 'လာမည့် စက္ကန်.အနည်းငယ် မှာ', 'prefix');
        test.equal(frozenMoment(0).from(30000), 'လွန်ခဲ့သော စက္ကန်.အနည်းငယ် က', 'suffix');
        test.done();
    },

    'now from now': function (test) {
        test.expect(1);
        test.equal(frozenMoment().fromNow(), 'လွန်ခဲ့သော စက္ကန်.အနည်းငယ် က', 'ယခုမှစပြီး အတိတ်တွင်ဖော်ပြသလိုဖော်ပြမည်');
        test.done();
    },
    ...
    'calendar day': function (test) {
        ...
        test.equal(frozenMoment(a).calendar(), 'ယနေ. ၀၂:၀၀ မှာ', 'ယနေ. ဒီအချိန်');
    ...
    'weeks year starting sunday formatted': function (test) {
        ...
        test.equal(frozenMoment([2012, 0, 1]).format('w ww wo'), '၅၂ ၅၂ ၅၂', 'Jan  1 2012 should be week 52');
        test.equal(frozenMoment([2012, 0, 2]).format('w ww wo'), '၁ ၀၁ ၁', 'Jan  2 2012 should be week 1');
        test.equal(frozenMoment([2012, 0, 8]).format('w ww wo'), '၁ ၀၁ ၁', 'Jan  8 2012 should be week 1');
        test.equal(frozenMoment([2012, 0, 9]).format('w ww wo'), '၂ ၀၂ ၂', 'Jan  9 2012 should be week 2');
        test.equal(frozenMoment([2012, 0, 15]).format('w ww wo'), '၂ ၀၂ ၂', 'Jan 15 2012 should be week 2');
    ...
    'returns the name of the locale': function (test) {
        if (typeof module !== 'undefined' && module.exports) {
            test.equal(require('../../locale/my'), 'my', 'module should export my');
        }
