...
exports["locale:cs"] = {
    ...
    "from" : function (test) {
        ...
        test.equal(start.from(frozenMoment([2007, 1, 28]).add({s: 44}), true),  "pár sekund",  "44 seconds = a few seconds");
        test.equal(start.from(frozenMoment([2007, 1, 28]).add({s: 45}), true),  "minuta",        "45 seconds = a minute");
        test.equal(start.from(frozenMoment([2007, 1, 28]).add({s: 89}), true),  "minuta",        "89 seconds = a minute");
        test.equal(start.from(frozenMoment([2007, 1, 28]).add({s: 90}), true),  "2 minuty",      "90 seconds = 2 minutes");
        test.equal(start.from(frozenMoment([2007, 1, 28]).add({m: 44}), true),  "44 minut",     "44 minutes = 44 minutes");
        ...
        test.equal(start.from(frozenMoment([2007, 1, 28]).add({h: 5}), true),   "5 hodin",      "5 hours = 5 hours");
        test.equal(start.from(frozenMoment([2007, 1, 28]).add({h: 21}), true),  "21 hodin",     "21 hours = 21 hours");
        test.equal(start.from(frozenMoment([2007, 1, 28]).add({h: 22}), true),  "den",       "22 hours = a day");
        test.equal(start.from(frozenMoment([2007, 1, 28]).add({h: 35}), true),  "den",       "35 hours = a day");
        test.equal(start.from(frozenMoment([2007, 1, 28]).add({h: 36}), true),  "2 dny",         "36 hours = 2 days");
        test.equal(start.from(frozenMoment([2007, 1, 28]).add({d: 1}), true),   "den",       "1 day = a day");
        ...
        test.equal(start.from(frozenMoment([2007, 1, 28]).add({d: 26}), true),  "měsíc",       "26 days = a month");
        test.equal(start.from(frozenMoment([2007, 1, 28]).add({d: 30}), true),  "měsíc",       "30 days = a month");
        test.equal(start.from(frozenMoment([2007, 1, 28]).add({d: 43}), true),  "měsíc",       "43 days = a month");
        test.equal(start.from(frozenMoment([2007, 1, 28]).add({d: 46}), true),  "2 měsíce",    "46 days = 2 months");
        test.equal(start.from(frozenMoment([2007, 1, 28]).add({d: 74}), true),  "2 měsíce",    "75 days = 2 months");
        test.equal(start.from(frozenMoment([2007, 1, 28]).add({d: 76}), true),  "3 měsíce",    "76 days = 3 months");
        test.equal(start.from(frozenMoment([2007, 1, 28]).add({M: 1}), true),   "měsíc",       "1 month = a month");
        test.equal(start.from(frozenMoment([2007, 1, 28]).add({M: 5}), true),   "5 měsíců",    "5 months = 5 months");
        ...
        test.equal(start.from(frozenMoment([2007, 1, 28]).add({y: 5}), true),   "5 let",         "5 years = 5 years");
        test.done();
    },

    "suffix" : function (test) {
        test.equal(frozenMoment(30000).from(0), "za pár sekund",  "prefix");
        test.equal(frozenMoment(0).from(30000), "před pár sekundami", "suffix");
        test.done();
    },

    "now from now" : function (test) {
        test.equal(frozenMoment().fromNow(), "před pár sekundami",  "now from now should display as in the past");
        test.done();
    },

    "fromNow (future)" : function (test) {
        test.equal(frozenMoment().add({s: 30}).fromNow(), "za pár sekund", "in a few seconds");
        test.equal(frozenMoment().add({m: 1}).fromNow(), "za minutu", "in a minute");
        test.equal(frozenMoment().add({m: 3}).fromNow(), "za 3 minuty", "in 3 minutes");
        test.equal(frozenMoment().add({m: 10}).fromNow(), "za 10 minut", "in 10 minutes");
        ...
        test.equal(frozenMoment().add({h: 10}).fromNow(), "za 10 hodin", "in 10 hours");
        test.equal(frozenMoment().add({d: 1}).fromNow(), "za den", "in a day");
        test.equal(frozenMoment().add({d: 3}).fromNow(), "za 3 dny", "in 3 days");
        test.equal(frozenMoment().add({d: 10}).fromNow(), "za 10 dní", "in 10 days");
        test.equal(frozenMoment().add({M: 1}).fromNow(), "za měsíc", "in a month");
        test.equal(frozenMoment().add({M: 3}).fromNow(), "za 3 měsíce", "in 3 months");
        test.equal(frozenMoment().add({M: 10}).fromNow(), "za 10 měsíců", "in 10 months");
        test.equal(frozenMoment().add({y: 1}).fromNow(), "za rok", "in a year");
        test.equal(frozenMoment().add({y: 3}).fromNow(), "za 3 roky", "in 3 years");
        test.equal(frozenMoment().add({y: 10}).fromNow(), "za 10 let", "in 10 years");
        test.done();
    },

    "fromNow (past)" : function (test) {
        test.equal(frozenMoment().subtract({s: 30}).fromNow(), "před pár sekundami", "a few seconds ago");
        test.equal(frozenMoment().subtract({m: 1}).fromNow(), "před minutou", "a minute ago");
        test.equal(frozenMoment().subtract({m: 3}).fromNow(), "před 3 minutami", "3 minutes ago");
        test.equal(frozenMoment().subtract({m: 10}).fromNow(), "před 10 minutami", "10 minutes ago");
        test.equal(frozenMoment().subtract({h: 1}).fromNow(), "před hodinou", "an hour ago");
        test.equal(frozenMoment().subtract({h: 3}).fromNow(), "před 3 hodinami", "3 hours ago");
        test.equal(frozenMoment().subtract({h: 10}).fromNow(), "před 10 hodinami", "10 hours ago");
        test.equal(frozenMoment().subtract({d: 1}).fromNow(), "před dnem", "a day ago");
        test.equal(frozenMoment().subtract({d: 3}).fromNow(), "před 3 dny", "3 days ago");
        test.equal(frozenMoment().subtract({d: 10}).fromNow(), "před 10 dny", "10 days ago");
        test.equal(frozenMoment().subtract({M: 1}).fromNow(), "před měsícem", "a month ago");
        test.equal(frozenMoment().subtract({M: 3}).fromNow(), "před 3 měsíci", "3 months ago");
        test.equal(frozenMoment().subtract({M: 10}).fromNow(), "před 10 měsíci", "10 months ago");
        test.equal(frozenMoment().subtract({y: 1}).fromNow(), "před rokem", "a year ago");
        test.equal(frozenMoment().subtract({y: 3}).fromNow(), "před 3 lety", "3 years ago");
        test.equal(frozenMoment().subtract({y: 10}).fromNow(), "před 10 lety", "10 years ago");
        test.done();
    },
    ...
    "calendar day" : function (test) {
        ...
        test.equal(frozenMoment(a).calendar(),                     "dnes v 2.00",     "today at the same time");
        test.equal(frozenMoment(a).add({m: 25}).calendar(),      "dnes v 2.25",     "Now plus 25 min");
        test.equal(frozenMoment(a).add({h: 1}).calendar(),       "dnes v 3.00",     "Now plus 1 hour");
        test.equal(frozenMoment(a).add({d: 1}).calendar(),       "zítra v 2.00",  "tomorrow at the same time");
        test.equal(frozenMoment(a).subtract({h: 1}).calendar(),  "dnes v 1.00",     "Now minus 1 hour");
        test.equal(frozenMoment(a).subtract({d: 1}).calendar(),  "včera v 2.00",     "yesterday at the same time");
        test.done();
    },
    ...
    "humanize duration" : function (test) {
        test.equal(frozenMoment.duration(1, "minutes").humanize(), "minuta", "a minute (future)");
        test.equal(frozenMoment.duration(1, "minutes").humanize(true), "za minutu", "in a minute");
        test.equal(frozenMoment.duration(-1, "minutes").humanize(), "minuta", "a minute (past)");
        test.equal(frozenMoment.duration(-1, "minutes").humanize(true), "před minutou", "a minute ago");
        test.done();
    },
